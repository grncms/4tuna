<%@ page language="java" contentType="text/html; charset=utf-8" pageEncoding="utf-8" %>
 ...
 <ul class="navbar-nav sidebar sidebar-dark accordion" id="accordionSidebar">
			...
			<div class="d-flex justify-content-center w-100 mb-3"><button type="button" class="btn btn-lg mt-1" id="btn-add" onclick="location.href='/classInvitation'">
            ...
            <li class="nav-item">
                ...
                <a class="nav-link" href="/chat"><i class="fa-solid fa-comment" style="color: #828282;"></i> <span>클래스 채팅</span></a>
