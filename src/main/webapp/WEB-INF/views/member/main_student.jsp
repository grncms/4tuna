...
<div class="container" id="main">
	...
	<div class="col-md-7" >
		...
		<div id="classNotice">
		<div class="mb-4" onclick="location.href='/classroom/common/classMain'"><img src="/resources/user/image/a3.jpg" width="45" height="45" style="border-radius: 7px;"><span style="font-size: 20px; font-weight: bold; margin-left: 20px; padding-top: 25px;">4조<i class="fa-solid fa-angle-right"></i></span></div>
	...
	<div class="col-md-5">
		...
		<div onclick="location.href='/classroom/common/classMain'">
